...
def main():
    ...
    kp = 4              #     kp = 6.9  15   1   10  7   15
    ki = 0.55           #     ki = 1    4    5   3   2   3
    kd = 18             #     kd = 41   0.1  50  15  15  20
...
#             if button_stateADD==1:
#                 sleep(0.2)
#                 integral = 0.0
#                 offseterror = offseterror+0.5
#                 
#             if button_stateDEE==1:
#                 sleep(0.2)
#                 integral = 0.0
#                 offseterror = offseterror-0.5
